            ...
            echo "<tr>";
                for($b=0;$b<12   ;$b++){
                    ...
                    foreach($estado_butacas as $butac4){
                         echo"".$butaca['ID_BUTACA']." // ".$butac4['ID_BUTACA']."<br>";
                        if($butaca['ID_BUTACA']==$butac4['ID_BUTACA']){
                            $libre = false;
                    ...
                    if($libre == true){
                        echo"<td id='libre'><input  type='checkbox' name='butaca".($contador+1)."' value='".$filas[$contador]['ID_BUTACA']."'></td>";
                        $pedido++;
                    }
                    $contador++;
                    ...
                    if($contador != ($limite-1)){
                        ...
                        echo"<td id='libre'>".$filas[$contador]['ID_BUTACA']."></td>";
                        $contador++;
                        $pedido++;
                    }else{echo"</tr>";}
                    */
